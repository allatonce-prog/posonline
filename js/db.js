        ...
        return new Promise((resolve, reject) => {
            ...
            request.onupgradeneeded = (event) => {
                ...
                if (!db.objectStoreNames.contains('deliveries')) {
                    ...
                    deliveryStore.createIndex('month', 'month', { unique: false });
                    deliveryStore.createIndex('storeId', 'storeId', { unique: false });
                    deliveryStore.createIndex('cashier', 'cashier', { unique: false });
                }

                // Modifiers store (New in v4)
